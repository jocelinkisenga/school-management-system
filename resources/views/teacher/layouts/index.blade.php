            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span> Mes cours</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{route('teacher.courses')}}">Mes cours</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="time-table.html"><i class="fas fa-table"></i> <span>Horaire</span></a>
                        </li>
                    </ul>
                </div>
            </div>
