            ...
            <div class="sidebar-inner slimscroll">
               <div id="sidebar-menu" class="sidebar-menu">
                  <ul>
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fas fa-user-graduate"></i> <span> Dashboard</span> <span class="menu-arrow"></span>
                     </li>
                     <li class="submenu active">
                        <a href=""><i class="fas fa-user-graduate"></i> <span> Eleves</span> <span class="menu-arrow"></span></a>
                        <ul>
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fas fa-building"></i> <span>option</span> <span class="menu-arrow"></span></a>
                        <ul>
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fas fa-book-reader"></i> <span>cours</span> <span class="menu-arrow"></span></a>
                        <ul>
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fas fa-file-invoice-dollar"></i> <span> Paiements</span> <span class="menu-arrow"></span></a>
                        <ul>
